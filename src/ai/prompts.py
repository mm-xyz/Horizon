...
- All *_zh fields MUST be written in Traditional Chinese (繁體中文). 絕對不能用英文寫 _zh 欄位的內容。Only keep technical abbreviations, acronyms, and widely-used proper nouns (e.g. "GPT-4", "CUDA", "Rust") in their original English form; everything else must be Traditional Chinese.
...
Respond with valid JSON only. Each _en field must be in English; each _zh field MUST be in Traditional Chinese (繁體中文). Every field MUST be at least one complete sentence (except community_discussion fields when no comments exist):
{{
  "title_en": "<short headline in English, ≤15 words>",
  "title_zh": "<用中文寫一個簡短標題，不超過15個詞>",
  "whats_new_en": "<1-2 sentences in English>",
  "whats_new_zh": "<用中文寫1-2句話>",
  "why_it_matters_en": "<1-2 sentences in English>",
  "why_it_matters_zh": "<用中文寫1-2句話>",
  "key_details_en": "<1-2 sentences in English>",
  "key_details_zh": "<用中文寫1-2句話>",
  "background_en": "<2-4 sentences in English, or empty string>",
  "background_zh": "<用中文寫2-4句話，或空字串>",
  "community_discussion_en": "<1-3 sentences in English, or empty string>",
  "community_discussion_zh": "<用中文寫1-3句話，或空字串>",
